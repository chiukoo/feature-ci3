	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<form role="form" class="validate" method="post" action="<?php echo base_url('indexAbout/indexAboutEditPost'); ?>">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $lang['content']?></label>
							<div class="col-sm-10">
								<textarea id="ckeditor02" class="ckeditor" name="content" rows="10" cols="80"><?php echo $userData['0']['content'];?></textarea>
