	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<form role="form" class="validate" method="post" action="<?php echo base_url('indexOther/indexOtherEditPost'); ?>">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $lang['youtube']?></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="youtube" data-validate="required" data-msg-required="<?php echo $lang['youtube'];?>" placeholder="" value="<?php echo $userData[0]['youtube'];?>"/>
							</div>
						</div>
