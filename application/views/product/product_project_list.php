...
<div class="panel panel-default">
	<div class="panel-body">
		<div style="text-align: right;">
			<a href="productProjectAdd"><button class="btn btn-white"><?php echo $lang['product_add'];?></button></a>
		</div>
			...
			<tbody class="middle-align" id="sortable">
				<?php foreach ($data as $value) {?>
					<tr data-id="<?php echo $value['id']?>" data-order="<?php echo $value['order']?>">
						...
						<td>
							<a href="productProjectEdit/id/<?php echo $value['id'];?>" class="btn btn-secondary btn-sm btn-icon icon-left">
