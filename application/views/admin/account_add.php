<div class="page-title">
	...
	<div class="breadcrumb-env">
		<ol class="breadcrumb bc-1">
			<li>
				<a href="<?php echo base_url('indexData/indexDataList'); ?>"><i class="fa-home"></i><?php echo $account['nav_index'];?></a>
			</li>
			<li class="active">
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<form role="form" class="validate" method="post" action="<?php echo base_url('admin/accountAddPost'); ?>">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $account['account_title']?></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="username" data-validate="required" data-msg-required="<?php echo $account['account_username_error'];?>" placeholder="" />
							</div>
						</div>
